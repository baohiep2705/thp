...
<li class="menu-item menu-item-type-post_type menu-item-object-page"><a style="padding:0;text-align:center;" href="http://www.thp.com.vn/en/"><img style="width:28%;" src="http://www.thp.com.vn/wp-content/uploads/2017/01/icon-eng.png" /></a></li>
                        </ul>
                    </nav>
                    <!-- #site-navigation -->
                </div>              
                <div class="contact-header"><span>CONTACT US: </span><a href="mailto:info@thp.com.vn">info@thp.com.vn</a></div>                
            </div>           
        </header><!-- #masthead -->
        <?php
    }
...
add_action( 'onepress_site_start_en', 'onepress_site_header_en' );
if ( ! function_exists( 'onepress_site_header_en' ) ) {
    /**
     * Display site header
     */
    function onepress_site_header_en(){
        ?>
        <header id="masthead" class="site-header" role="banner">
            <div class="container">
                <div class="site-branding">
               		<div class="site-brand-inner has-logo-img no-desc">
                    	<div class="site-logo-div">
                        	<a class="custom-logo-link" href="http://www.thp.com.vn/en/">
                            	<img src="http://www.thp.com.vn/wp-content/uploads/2017/01/cropped-thp.png" />
                            </a>
                        </div>
                    </div>
                </div> 
                ...
                <div class="header-right-wrapper">
                    ...
                    <nav id="site-navigation" class="main-navigation" role="navigation">
                        <ul class="onepress-menu">
                            <?php wp_nav_menu(array('theme_location' => 'primary-eng', 'container' => '', 'items_wrap' => '%3$s')); ?>
<li class="menu-item menu-item-type-custom menu-item-object-custom"><a style="padding:0;text-align:center;" href="http://www.thp.com.vn/"><img src="http://www.thp.com.vn/wp-content/uploads/2017/01/icon-vn.png" style="width:20%" /></a></li>
                        </ul>
...
if ( ! function_exists( 'onepress_posted_on' ) ) {
    ...
    function onepress_posted_on()
    {
        ...
        $posted_on = sprintf(
            esc_html_x('Đăng ngày %s', 'post date', 'onepress'),
    ...
    function onepress_entry_footer()
    {
        ...
        if ('post' === get_post_type()) {
            ...
            if ($categories_list && onepress_categorized_blog()) {
                printf('<span class="cat-links">' . esc_html__('Chuyên mục: %1$s', 'onepress') . '</span>', $categories_list); // WPCS: XSS OK.
            }
...
if ( ! function_exists( 'onepress_footer_site_info' ) ) {
    ...
    function onepress_footer_site_info()
    {
       ...
       <!-- <?php printf(esc_html__('%1$s theme by %2$s', 'onepress'), '<a href="' . esc_url('http://www.thp.com.vn/', 'onepress') . '">OnePress</a>', 'FameThemes'); ?>-->
        <?php
    }
}
