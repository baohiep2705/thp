        ...
        if ( $onepress_newsletter_disable != '1' || $onepress_social_disable != '1' ) : ?>
			...
			<div class="col-sm-2">
				...
				<div class="contact-footer"  style="text-align:left">
					<h5 class="follow-heading">MEDIA CONTACT</h5>
					<div>
                        ...
                        <div class="<?php if ( $onepress_newsletter_disable == '1' ) {
                            ...
                            if ($onepress_social_disable != '1') {
                                ...
                                <div class="footer-social">
                                    <?php
                                    if ($onepress_social_footer_title != '') echo '<h5 class="follow-heading">social channels</h5>';
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="sitemap">
					...
					<div>
						<a href="#">Sitemap</a> |
						<a href="http://www.thp.com.vn/privacy-policy/">Privacy Policy</a>
					</div>
				</div>
			</div>
		</div>
	 ...
	 <div class="site-info sitemap1">
        ...
        <div class="site-info">
            <div class="container">
                ...
                <?php endif; ?>
                <span>© THP GROUP. ALLRIGHTS RESERVED.</span>
            </div>
        </div>
        <!-- .site-info -->
